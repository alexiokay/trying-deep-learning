...
data = tf.keras.utils.image_dataset_from_directory('data', labels='inferred', label_mode='categorical', batch_size=128) #, batch_size=32 #, image_size=(256, 256)
...
hist = model.fit(train, epochs=30, validation_data=val, callbacks=[tensorboard_callback, early_stopping_loss, early_stopping_acc])

...
train_gen = train_datagen.flow(X_train_scaled, y_train, batch_size=92, shuffle=True)
...
model.add(Conv2D(32, (3,3), 1, activation='relu', padding="valid", input_shape=(256,256,3)))
...
hist = model.fit(train_gen, epochs=60, validation_data=(X_valid, y_valid), callbacks=[tensorboard_callback, early_stopping_loss, early_stopping_acc])
